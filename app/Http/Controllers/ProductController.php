...
use App\Application\Category\UseCases\ProductsByCategoryUseCase;
use App\Application\Category\UseCases\ProductsByCategoryWithFilterUseCase;
...
class ProductController extends Controller
{
    ...
    {
        $data = CategoriesWithAllNestingsIds::fromRequest($request);
        $use_case = new ProductsByCategoryUseCase(new EloquentCategoryRepository);
        return $use_case->execute($data);
    }

    public function catalogFilter(CatalogFilterRequest $request)
    {

        $data = CategoriesWithAllNestingsIdsFilter::fromRequest($request);
        $use_case = new ProductsByCategoryWithFilterUseCase(new EloquentCategoryRepository);
        return $use_case->execute($data);
    }
