...
const addCharacteristic = () => {
    ...
    if(useCreateProductStore().characteristics.length >= 20){
...
<template>
    ...
    <div v-for="(characteristic, index) in useCreateProductStore().characteristics" :key="index" class="flex items-center gap-x-2.5 mt-2.5 ">
        ...
        <img @click.prevent="useCreateProductStore().characteristics.splice(index, 1)" class="w-10 h-10 cursor-pointer rounded-md hover:shadow-[0_0px_15px_0_rgba(255,0,0,1)] transition duration-150" src="/public/img/delete.svg" alt="delete">
    </div>
