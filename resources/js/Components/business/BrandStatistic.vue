...
<template>
    ...
    <div v-if="!changeBrandNameFlag" class="flex gap-x-2.5 items-center mt-2.5">
    ...
    <div v-if="changeBrandNameFlag" class="flex gap-x-2.5 items-center mt-2.5">
        <input v-model="brandName" :readonly="load.changeNameBrand" type="text" class="p-2.25 w-70 h-7.5 border-2 border-lime-500 rounded-[10px] focus:outline-none max-[385px]:w-auto" :placeholder="useTranslateStore().t('enterBrand')">
    ...
    <div class="flex flex-wrap gap-2.5 justify-between mt-2.5">
